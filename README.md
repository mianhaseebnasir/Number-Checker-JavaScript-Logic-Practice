...
✔ Dynamic name prompt for personalization
✔ Real-time number validation logic
✔ Even/Odd detection using modulo operator
...
• Convert the input value into a Number data type.

• Use the modulo operator % to evaluate:

  • If number % 2 === 0 → Even Number

  • Else → Odd Number

• Dynamically update the result field using DOM manipulation.
...
• Logical decision-making using if/else

• JavaScript functions

• Working with document.getElementById
...
• Replace prompt() with an input field

• Improve UI with CSS styling

• Add error handling for empty or invalid input

• Convert into a fully responsive mini web app
